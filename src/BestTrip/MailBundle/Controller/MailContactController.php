...
class MailContactController extends Controller
{
    ...
    public function sendMailAction(Request $request) { 
        ...
        //if ($form->isValid()) { 
           ...
           return $this->render('BestTripMailBundle:MailContact:mail.html.twig', array('to' => $to, 
                            'from' => $mail->getEmail() 
                )); 
        } 
        return $this->redirect($this->generateUrl('wee_go_mail_form_contact')); 
    } 
    ...
    public function newAction() { 
        ...
        return $this->render('BestTripMailBundle:MailContact:MailContact.html.twig', array('form' =>$form->createView())); 
        } 
}
